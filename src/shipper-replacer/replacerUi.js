...
(function() {
  ...
  // SHIPPER_CONFIG is not used directly in this file
  ...
  VH.replacerUi = {
    ...
    showConfirmationDialog(data) {
      return new Promise(resolve => {
        ...
        backdrop.className = 'fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center p-4 z-50'; // Consider moving z-index to CONFIG
