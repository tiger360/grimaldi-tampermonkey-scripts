...
(function() {
  ...
  const { vehicleConfig, vehicleMessages, notifications, dom, iframes, vehicleDom, vehicleUi } = VH;
  const { show } = notifications;
  // Note: domHelpers and iframeHelpers are already accessed via VH.dom and VH.iframes

  /**
   * Main controller for the Vehicle Handler script.
   */
  VH.vehicleMain = {
    // State
