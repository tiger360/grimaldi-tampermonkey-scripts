...
const { getBookingDocument, setFieldValue, getTableRows, waitForNewRow } = VH.dom;
const { mapAttachmentType, mapPriority, DEBUG } = VH.utils;
...
const VEHICLE_FIELDS = [
  ...
  { prefix: 'TextBox_DoG',             getValue: (veh, id, doc) =>
      doc.getElementById('HiddenField_POD').value === 'CMDLA'
...
VH.vehicleDom = {
  ...
  findVehicleDataByChassis(chassis) {
    const vehicles = VH.vehicleMain.vehiclesFromClipboard || [];
